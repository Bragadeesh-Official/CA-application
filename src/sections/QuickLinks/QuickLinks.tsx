        ...
        <section className="py-20 bg-white">
            <div className="max-w-[1720px] mx-auto px-6">
                <div className="flex flex-col items-center text-center gap-4 mb-16">
                    <h2 className="text-indigo-600 font-bold tracking-widest uppercase text-xs md:text-sm">Explore Further</h2>
                    <h3 className="text-3xl md:text-4xl font-bold text-gray-900">
                        Quick Access to <span className="text-indigo-600">Key Information</span>
                    </h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {links.map((link, index) => (
                        ...
                        >
                            ...
                            <div className="mt-auto flex items-center gap-2 text-indigo-600 font-bold text-sm group-hover:translate-x-2 transition-transform">
                                Learn More
                                <ArrowRight size={18} />
                            </div>
                        </div>
